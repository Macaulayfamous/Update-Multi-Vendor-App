...
import 'package:maclay_multi_store/vendor/views/screens/vendorProductDetail/vendor_product_detail_screen.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            TextButton(
              onPressed: () {
                Get.to(VendorStoreDetail(vendorData: widget.productData));
              },
              child: Text('see more'),
            ),
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child:
                      Icon(CupertinoIcons.cart, color: Colors.white, size: 25),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
